		...
		<div class="med">
			...
			<section class="contenido">
				<div class="news">
					...
					<select id="origen" name="origen" onchange="mostrar_ciudades()" onload="mostrar_ciudades()">
			...
			<input id="submit" type="submit" value="Buscar" onclick="mostrar_vuelos()" />
			
			<div id="oculta"><table id="tabla_vuelos" class="tabla" style="width:100%;"></table></div>		
				</div>
				</section>
